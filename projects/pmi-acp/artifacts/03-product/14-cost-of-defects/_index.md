...
| **Key Points** | **Cheapest → Most Expensive:** 1. Peer programming (caught live, ~$0 extra) 2. Continuous Integration (caught at code merge) 3. Test-Driven Development (caught during unit tests) 4. Reviewer / Customer Inspection (code is working, much more to unwind) 5. System Testing (entire system involved) 6. Design Defect (wrong language/platform — rebuild from scratch) 7. User Acceptance Testing (back to requirements) 8. **Production** (most expensive — recall, reputation loss, legal) | **Rẻ nhất → Đắt nhất:** 1. Peer programming (bắt ngay, ~$0 thêm) 2. Continuous Integration (bắt khi merge code) 3. Test-Driven Development (bắt trong unit test) 4. Reviewer / Customer Inspection (code đang chạy, nhiều thứ phải tháo) 5. System Testing (toàn hệ thống liên quan) 6. Design Defect (sai ngôn ngữ/nền tảng — làm lại từ đầu) 7. User Acceptance Testing (quay lại requirements) 8. **Production** (đắt nhất — thu hồi, mất uy tín, pháp lý) |
